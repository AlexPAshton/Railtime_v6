...
namespace Railtime_v6
{
    ...
    public class RtStationData
    {
        ...
        private string _StationNameUpper;//Name of station uppered for quicker search
        ...
        public string StationName { get { return _StationName; } }

        //Set and Get for StationNameUpper
        public string StationNameUpper { get { return _StationNameUpper; } }

        //Set and Get for Code
        public string Code { get { return _Code; } }

        //Set and Get for Easting
        public double Easting { get { return _Easting; } }

        //Set and Get for Northing
        public double Northing { get { return _Northing; } }
        ...
        public RtStationData (string StationName, string Code, double Easting, double Northing, LatLon LatLon)
        {
            ...
            this._StationNameUpper = StationName.ToUpper();
            this._Code = Code;
