...
namespace Railtime_v6
{
    ...
    public class RtStationSearchDialog
    {
        ...
        private void GenerateView()
        {
            ...
            DialogLocation.SetImageResource(Resource.Drawable.Icon_Location);
            ...
            DialogNavigatable.SetImageResource(Resource.Drawable.Icon_Navigation);
        ...
        private void DrawResults(LinearLayout ResultsRoot, RtGPS GPS)
        {
            ...
            {
                //Search stations
                RtStationData[] data = new RtStations().SearchStations(SearchInput.Text, MAXSEARCHRESULTS, GPS, false);
